...
class DataIngestion:
    ...
    def download_insurance_data(self,) -> str:
        try:
            #extracting removed url to download dataset
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact :
        try:
            ...
            for train_index,test_index in split.split(insurance_data_frame, insurance_data_frame["region"]):
                strat_train_set = insurance_data_frame.loc[train_index]
                strat_test_set = insurance_data_frame.loc[test_index]
